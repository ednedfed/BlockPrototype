...
public partial class MainGameContext : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        AddToWorldAndGroupSystemManaged(new GhostBlockTypeSyncSystem(blockTypes), world, simulationGroup);
        ...
        AddToWorldAndGroupSystemManaged(new GhostPositionUpdateSystem(character), world, fixedStepSimulationGroup);
